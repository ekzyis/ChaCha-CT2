...
{
    class GeneralKeystreamBlockGenPage : Page
    {
        ...
        public GeneralKeystreamBlockGenPage(ContentControl pageElement, ChaChaPresentation pres_, ulong keyblockNr_) : base(pageElement)
        {
            pres = pres_;
        ...
        {
            uint[] state = GetMappedResult(ResultType.CHACHA_HASH_QUARTERROUND, (round * 4) - 1);
            (int i, int j, int k, int l) = GetStateIndicesFromQRIndex(qrIndex);
